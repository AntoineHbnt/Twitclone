        ...
        <div className="top">
          ...
          <div className="form">
            ...
            <div className="input-field">
              <div className="input-container">
                <div className="input-wrapper">
                  ...
                  <div className="counter"><span>0/50</span></div>
                </div>
            ...
            <div className="input-field">
              <div className="input-container">
                <div className="input-wrapper">
                  <div className="label"><span>Téléphone</span></div>
                </div>
                <div className="field-container">
                  <div className="field">
            ...
            <span className="option-switch">Utiliser un email</span>
